...
SFX_WEAPON_SELECT = _s("sfx_weapon_select.wav")  # запасной (нет файла -> тихо)
SFX_WEAPON_SYRUP = _s("sfx_weapon_syrup.wav")   # переключение на сироп
...
SFX_BLACK_KING_PHASE2 = _s("sfx_bk_phase2.wav")   # переход в фазу 2 (нет файла → spawn-звук)
...
SFX_BK_CUP_SHOOT = _s("sfx_bk_cup_shoot.wav")     # выстрел ожившего стакана (нет → тихо)

# ---------- Музыка (assets/sounds/) ----------
MUSIC_TUTORIAL = _s("music_tutorial.wav")  # музыка обучения (нет файла -> тихо)
...
FONT_WORLD = _f("world.ttf")     # 3D-текст: ники над червями, шкала босса
